...
public record CarverAdaption(HolderSet<Biome> targetBiomes, GenerationStep.Carving carvingStage, HolderSet<ConfiguredWorldCarver<?>> carvers) implements IBiomeAdaptation {
